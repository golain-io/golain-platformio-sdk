...
#define DEVICE_SHADOW_TOPIC ROOT_TOPIC DEVICE_NAME "/device-shadow"
...
#define DEVICE_FLAG ROOT_TOPIC DEVICE_NAME "/flag"
...
#define DEVICE_OTA_TOPIC ROOT_TOPIC DEVICE_NAME "/device-ota"
...
#define USER_ASSOC_TOPIC ROOT_TOPIC DEVICE_NAME "/user" // (posts user id to the topics)
...
#define DEVICE_DATA_TOPIC ROOT_TOPIC DEVICE_NAME "/device-data/"
// special data type topics
#define DEVICE_LOCATION DEVICE_DATA_TOPIC "location"
#define DEVICE_HEALTH_TOPIC ROOT_TOPIC DEVICE_NAME "/health"
#define DEVICE_LOG_TOPIC ROOT_TOPIC DEVICE_NAME "/log"
